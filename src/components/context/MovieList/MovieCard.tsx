  ...
  return (
    <div className="col-span group relative h-[12vw] bg-zinc-900">
      <img
        ...
        alt="Thumbnail"
      />
      <div className="group-hover:tranlate-x-[2vw] invisible absolute top-0 z-10 w-full scale-0 opacity-0 transition delay-300 duration-200 group-hover:-translate-y-[6vw] group-hover:scale-110 group-hover:opacity-100 sm:visible">
        <img
